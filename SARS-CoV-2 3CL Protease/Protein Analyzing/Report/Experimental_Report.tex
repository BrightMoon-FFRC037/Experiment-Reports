...
\section{Thermodynamic Parameters Measuring}
For practical purposes, we chose the reaction of \ce{MgCl} and \ce{EDTA} to be measured instead of the binding of inhibitor with protein.
...
\begin{figure}
    ...
    \subfigure[Ligand in the Pocket of Receptor]{
        \includegraphics[width=0.5\linewidth]{../Figures/Receptor and Ligand 16.png}
    }
    \subfigure[Hydrogen Bond (Gln-110,Arg-298)]{
        \includegraphics[width=0.5\linewidth]{../Figures/H-Bond.png}
    }
    \subfigure[pi-pi Interaction (Phe-294)]{
        \includegraphics[width=0.5\linewidth]{../Figures/pi-pi interaction.png}
    }
